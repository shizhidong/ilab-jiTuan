<template>
  <section ilab-Review-CollarUse-01>
    ...
    >
      ...
      <el-table-column prop="Use" label="申购数量" min-width="100"></el-table-column>
      <el-table-column prop="mechanism" label="申购机构" min-width="180"></el-table-column>
      <el-table-column prop="Employer" label="申购人" min-width="100"></el-table-column>
      <el-table-column prop="data" label="申购日期" min-width="180"></el-table-column>
