<template>
  <section ilab-Setting-ApprovalSettings>
    <!--工具条-->
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <label class="lin-1">共享库产品领用由</label>
        <el-form-item class="lin-2"> 
        ...
        <label class="lin-3">审批</label>
        <el-form-item class="lin-4">
          <el-button type="primary" v-on:click="getUsers">保存</el-button>
        </el-form-item>
      </el-form>
      <el-form :inline="true" :model="filters">
        <label class="lin-1">共享库产品申购由</label>
        <el-form-item class="lin-2">
          <el-select v-model="value1" placeholder="请选择">
            <el-option
              v-for="item in options1"
      ...
      <el-form :inline="true" :model="filters">
        <label class="lin-1">子库产品采购由</label>
        <el-form-item class="lin-2">
          <el-select v-model="value1" placeholder="请选择">
            <el-option
              v-for="item in options1"
...
@import "../../assets/style/Setting/ApprovalSettings.scss";
</style>